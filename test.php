...
<html lang="en">
  ...
  <body>
    ...
    <?php
      $sql = "SELECT sku, name, price, type, dvd_size, book_weight, furniture_height, furniture_width, furniture_length FROM products_2";
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            echo '<input type="checkbox"  name="delete[]"  class="item-checkbox"  value="' . htmlspecialchars($row["sku"]) . '" />';
